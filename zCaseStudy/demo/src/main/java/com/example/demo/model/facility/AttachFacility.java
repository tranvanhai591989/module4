...
public class AttachFacility {
    ...
    public AttachFacility(int attachFacilityId, String attachFacilityName, double attachFacilityCost, String attachFacilityUnit, String attachFacilityStatus, Set<ContractDetail> contractDetails) {
