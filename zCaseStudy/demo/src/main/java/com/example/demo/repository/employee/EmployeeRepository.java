...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
    ...
    @Modifying
    @Query(value = "update  employee  set employee_name=:employeeName, employee_birth=:employeeBirth , " +
            " employee_id_card=:employeeIdCard, employee_salary=:employeeSalary, employee_phone_number=:employeePhoneNumber , " +
            "  employee_email=:employeeEmail, employee_address=:employeeAddress , position_id=:position , " +
            "education_degree_id=:educationDegree, division_id=:division  ,user_name=:users " +
